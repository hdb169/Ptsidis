...
void D2_skim_file_July21(int RunGroup = 0){
  ...
  json j_simc;
  {
    ...
    //old std::ifstream ifs("db2/csvsimc_rungroup_april28_rho_delta_inc_exc.json");
    std::ifstream ifs("db2/correctnormfac_May9.json");

////csvsimc_rungroup_april28_rho_delta_inc_exc.json");// new May 10, 2022, 10k-300kevts.
 ...
 ifs>>j_simc;
  ...
  std::string D2_neg_inc_norad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_norad.root";
  std::string D2_neg_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_rad.root";
  std::string D2_neg_exc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_rad.root";
  std::string D2_neg_rho_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_neg_rho.root";
  std::string D2_neg_delta_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_neg_delta.root";
  // std::string Dummy_neg_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_Dummy_neg_inc_rad.root";
  std::string D2_pos_inc_norad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_norad.root";
  std::string D2_pos_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_rad.root";
  std::string D2_pos_exc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_rad.root";
  std::string D2_pos_rho_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_pos_rho.root";
  std::string D2_pos_delta_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_D2_pos_delta.root";
  // std::string Dummy_pos_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_Dummy_pos_inc_rad.root";

// std::string D2_neg_inc_norad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_norad.root";
//   std::string D2_neg_inc_rad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_rad.root";
//   std::string D2_neg_exc_rad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_rad.root";
//   std::string D2_neg_rho_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_rho.root";
//   std::string D2_neg_delta_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_neg_delta.root";
...
//   std::string D2_pos_inc_norad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_norad.root";
//   std::string D2_pos_inc_rad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_rad.root";
//   std::string D2_pos_exc_rad_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_rad.root";
//   std::string D2_pos_rho_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_rho.root";
//   std::string D2_pos_delta_rootfile_name = "/home/hdbhatt/simcROOTfiles/csv_"+std::to_string(RunGroup)+"_D2_pos_delta.root";
...
/*
  std::string D2_neg_inc_norad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_norad.root";
  std::string D2_neg_inc_rad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_neg_inc_rad.root";
  //std::string D2_neg_exc_rad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_neg_exc_rad.root";
  std::string D2_neg_rho_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_neg_rho.root";
  //std::string D2_neg_delta_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_neg_delta.root";
  std::string Dummy_neg_inc_rad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_Dummy_neg_inc_rad.root";
  std::string D2_pos_inc_norad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_norad.root";
  std::string D2_pos_inc_rad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_pos_inc_rad.root";
  // std::string D2_pos_exc_rad_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_pos_exc_rad.root";
  std::string D2_pos_rho_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_pos_rho.root";
  //std::string D2_pos_delta_rootfile_name = "worksim/csv_"+std::to_string(RunGroup)+"_D2_pos_delta.root";
...
*/
  ...
  d_D2_neg_inc_norad.Snapshot("T_neg_inc_norad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","phipq","thetapq","ppi", "pt"});
...
.Define("pt",pt,{"momentum","thetapq"})
  ...
  auto d_D2_pos_inc_norad = d_D2_pos_inc_norad_1.Define("weight_new",[wfac_D2_pos_inc_norad](float weight){return wfac_D2_pos_inc_norad*weight;},{"Weight"})
    ;
  d_D2_pos_inc_norad.Snapshot("T_pos_inc_norad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","phipq","thetapq","ppi","pt"},opts);
  ...
  d_D2_neg_exc_rad.Snapshot("T_neg_exc_rad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  ...
  d_D2_pos_exc_rad.Snapshot("T_pos_exc_rad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  ...
  d_D2_neg_inc_rad.Snapshot("T_neg_inc_rad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  ...
  d_D2_pos_inc_rad.Snapshot("T_pos_inc_rad",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  ...
  std::cout<<"This is Good : "<<nentries_D2_pos_inc_rad<<"Look For Normfac For Neg Rho"<<std::endl;
  ...
  std::cout<<"This is Good 2 Found RHo Norm: "<<nentries_D2_pos_inc_rad<<std::endl;
  ...
  d_D2_neg_rho.Snapshot("T_neg_rho",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  //pos rho 

  std::cout<<"This is Good 2: "<<nentries_D2_pos_inc_rad<<std::endl;
  ...
  d_D2_pos_rho.Snapshot("T_pos_rho",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  
  std::cout<<"this os Good  TOO: "<<nentries_D2_pos_inc_rad<<std::endl;
  ...
  d_D2_neg_delta.Snapshot("T_neg_delta",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  //pos delta 
  ...
  std::cout<<"sim normfac"<<normfac_D2_pos_delta<<"neg"<<normfac_D2_neg_delta<<std::endl;
  ...
  d_D2_pos_delta.Snapshot("T_pos_delta",skim_name.c_str(),{"xbj","z","Q2","W2","W","Em","missmass","Mx2","Pm","weight_new","ssxptar","ssyptar","ssytar","ssdelta","ssxpfp","ssypfp","hsxptar","hsyptar","hsdelta","pt","phipq"},opts);
  ...
  auto h_Q2_D2_neg_inc_norad = d_D2_neg_inc_norad.Histo1D({"Q2_neg_inc_norad","Q2_neg_inc_norad",bins,0,10},"Q2","weight_new");
  auto h_Q2_D2_pos_inc_norad = d_D2_pos_inc_norad.Histo1D({"Q2_pos_inc_norad","Q2_pos_inc_norad",bins,0,10},"Q2","weight_new");
  auto h_xbj_D2_neg_inc_norad = d_D2_neg_inc_norad.Histo1D({"xbj_neg_inc_norad","xbj_neg_inc_norad",bins,0,1},"xbj","weight_new");
  auto h_xbj_D2_pos_inc_norad = d_D2_pos_inc_norad.Histo1D({"xbj_pos_inc_norad","xbj_pos_inc_norad",bins,0,1},"xbj","weight_new");
  auto h_z_D2_neg_inc_norad = d_D2_neg_inc_norad.Histo1D({"z_neg_inc_norad","z_neg_inc_norad",bins,0,1},"z","weight_new");
  ...
  auto h_pt_D2_neg_inc_norad = d_D2_neg_inc_norad.Histo1D({"pt_neg_inc_norad","pt_neg_inc_norad",bins,0,1},"pt","weight_new");
  auto h_pt_D2_pos_inc_norad = d_D2_pos_inc_norad.Histo1D({"pt_pos_inc_norad","pt_pos_inc_norad",bins,0,1},"pt","weight_new");

 auto h_phi_D2_neg_inc_norad = d_D2_neg_inc_norad.Histo1D({"phi_neg_inc_norad","phi_neg_inc_norad",binsphi, -1,7 },"phipq","weight_new");
  auto h_phi_D2_pos_inc_norad = d_D2_pos_inc_norad.Histo1D({"phi_pos_inc_norad","phi_pos_excc_rad",binsphi, -1,7 },"phipq","weight_new");
  ...
  auto h_xs_xbj_pos_inc_norad = d_D2_pos_inc_norad.Histo2D({"xs_xbj_pos_inc_rad","xs_xbj_pos_inc_rad",bins,0,1,bins,0,1},"xbj","siglab","weight_new");
  std::cout<<"inc norad check"<<std::endl;  
  
  //////////////////uncommented below block
auto h_Q2_D2_neg_exc_rad = d_D2_neg_exc_rad.Histo1D({"Q2_neg_exc_rad","Q2_neg_exc_rad",bins,0,10},"Q2","weight_new");
  auto h_Q2_D2_pos_exc_rad = d_D2_pos_exc_rad.Histo1D({"Q2_pos_exc_rad","Q2_pos_exc_rad",bins,0,10},"Q2","weight_new");
  auto h_xbj_D2_neg_exc_rad = d_D2_neg_exc_rad.Histo1D({"xbj_neg_exc_rad","xbj_neg_exc_rad",bins,0,1},"xbj","weight_new");
  auto h_xbj_D2_pos_exc_rad = d_D2_pos_exc_rad.Histo1D({"xbj_pos_exc_rad","xbj_pos_exc_rad",bins,0,1},"xbj","weight_new");
  auto h_z_D2_neg_exc_rad = d_D2_neg_exc_rad.Histo1D({"z_neg_exc_rad","z_neg_exc_rad",bins,0,1},"z","weight_new");
  ...
  auto h_pt_D2_neg_exc_rad = d_D2_neg_exc_rad.Histo1D({"pt_neg_exc_rad","pt_neg_exc_rad",bins,0,1},"pt","weight_new");
  auto h_pt_D2_pos_exc_rad = d_D2_pos_exc_rad.Histo1D({"pt_pos_exc_rad","pt_pos_exc_rad",bins,0,1},"pt","weight_new");

  auto h_phi_D2_neg_exc_rad = d_D2_neg_exc_rad.Histo1D({"phi_neg_exc_rad","phi_neg_exc_rad",binsphi, -1,7 },"phipq","weight_new");
  auto h_phi_D2_pos_exc_rad = d_D2_pos_exc_rad.Histo1D({"phi_pos_exc_rad","phi_pos_excc_rad",binsphi, -1,7 },"phipq","weight_new");
...
/////////////////Uncommented aboove block/////////
  ...
  auto h_xbj_D2_neg_inc_rad = d_D2_neg_inc_rad.Histo1D({"xbj_neg_inc_rad","xbj_neg_inc_rad",bins,0,1},"xbj","weight_new");
  auto h_xbj_D2_pos_inc_rad = d_D2_pos_inc_rad.Histo1D({"xbj_pos_inc_rad","xbj_pos_inc_rad",bins,0,1},"xbj","weight_new");
  auto h_z_D2_neg_inc_rad = d_D2_neg_inc_rad.Histo1D({"z_neg_inc_rad","z_neg_inc_rad",bins,0,1},"z","weight_new");
  ...
  auto h_pt_D2_neg_inc_rad = d_D2_neg_inc_rad.Histo1D({"pt_neg_inc_rad","pt_neg_inc_rad",bins,0,1},"pt","weight_new");
  auto h_pt_D2_pos_inc_rad = d_D2_pos_inc_rad.Histo1D({"pt_pos_inc_rad","pt_pos_inc_rad",bins,0,1},"pt","weight_new");

  auto h_phi_D2_neg_inc_rad = d_D2_neg_inc_rad.Histo1D({"phi_neg_inc_rad","phi_neg_inc_rad",binsphi, -1,7 },"phipq","weight_new");
  auto h_phi_D2_pos_inc_rad = d_D2_pos_inc_rad.Histo1D({"phi_pos_inc_rad","phi_pos_inc_rad",binsphi, -1,7 },"phipq","weight_new");
  ...
  auto h_xbj_D2_neg_rho = d_D2_neg_rho.Histo1D({"xbj_neg_rho","xbj_neg_rho",bins,0,1},"xbj","weight_new");
  auto h_xbj_D2_pos_rho = d_D2_pos_rho.Histo1D({"xbj_pos_rho","xbj_pos_rho",bins,0,1},"xbj","weight_new");
  auto h_z_D2_neg_rho = d_D2_neg_rho.Histo1D({"z_neg_rho","z_neg_rho",bins,0,1},"z","weight_new");
  ...
  //pt
  auto h_pt_D2_neg_rho = d_D2_neg_rho.Histo1D({"pt_neg_rho","pt_neg_rho",bins,0,1},"pt","weight_new");
  auto h_pt_D2_pos_rho = d_D2_pos_rho.Histo1D({"pt_pos_rho","pt_pos_rho",bins,0,1},"pt","weight_new");
  //phi
  auto h_phi_D2_neg_rho = d_D2_neg_rho.Histo1D({"phi_neg_rho","phi_neg_rho",binsphi, -1,7 },"phipq","weight_new");
  auto h_phi_D2_pos_rho = d_D2_pos_rho.Histo1D({"phi_pos_rho","phi_pos_rho",binsphi, -1,7 },"phipq","weight_new");
  ...
  auto h_Q2_D2_pos_delta = d_D2_pos_delta.Histo1D({"Q2_pos_delta","Q2_pos_delta",bins,0,10},"Q2","weight_new");
  auto h_xbj_D2_neg_delta = d_D2_neg_delta.Histo1D({"xbj_neg_delta","xbj_neg_delta",bins,0,1},"xbj","weight_new");
  auto h_xbj_D2_pos_delta = d_D2_pos_delta.Histo1D({"xbj_pos_delta","xbj_pos_delta",bins,0,1},"xbj","weight_new");
  auto h_z_D2_neg_delta = d_D2_neg_delta.Histo1D({"z_neg_delta","z_neg_delta",bins,0,1},"z","weight_new");
  ...
  auto h_pt_D2_neg_delta = d_D2_neg_delta.Histo1D({"pt_neg_delta","pt_neg_delta",bins,0,1},"pt","weight_new");
  auto h_pt_D2_pos_delta = d_D2_pos_delta.Histo1D({"pt_pos_delta","pt_pos_delta",bins,0,1},"pt","weight_new");

 auto h_phi_D2_neg_delta = d_D2_neg_delta.Histo1D({"phi_neg_delta","phi_neg_delta",binsphi, -1,7 },"phipq","weight_new");
  auto h_phi_D2_pos_delta = d_D2_pos_delta.Histo1D({"phi_pos_delta","phi_pos_delta",binsphi, -1,7 },"phipq","weight_new");
  ...
  //std::string rootfile_out_name = "results/yield20binspt/kinematics_D2_yield_"+std::to_string(RunGroup)+"_simc.root";

  std::string rootfile_out_name = "results/yield20binsptt_july/kinematics_D2_yield_"+std::to_string(RunGroup)+"_simc.root";
...
h_Q2_D2_neg_inc_rad->Write();
  ...
  h_pt_D2_neg_inc_norad->Write();
  h_pt_D2_pos_inc_norad->Write();

  h_pt_D2_neg_inc_rad->Write();
  h_pt_D2_pos_inc_rad->Write();

  //h_pt_D2_neg_exc_rad->Write();
  //h_pt_D2_pos_exc_rad->Write();

  // h_pt_D2_neg_delta->Write();
  // h_pt_D2_pos_delta->Write();

  h_pt_D2_neg_rho->Write();
  h_pt_D2_pos_rho->Write();


  h_phi_D2_neg_inc_norad->Write();
  h_phi_D2_pos_inc_norad->Write();

  h_phi_D2_neg_inc_rad->Write();
  h_phi_D2_pos_inc_rad->Write();

  //h_phi_D2_neg_exc_rad->Write();
  // h_phi_D2_pos_exc_rad->Write();

  // h_phi_D2_neg_delta->Write();
  // h_phi_D2_pos_delta->Write();

  h_phi_D2_neg_rho->Write();
  h_phi_D2_pos_rho->Write();
  ...
  double pos_inc_norad = h_z_D2_pos_inc_norad->Integral();
  double neg_inc_norad = h_z_D2_neg_inc_norad->Integral();
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["pos"]["inc_norad"] = pos_inc_norad;
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["neg"]["inc_norad"] = neg_inc_norad;
  double pos_inc_rad = h_z_D2_pos_inc_rad->Integral();
  double neg_inc_rad = h_z_D2_neg_inc_rad->Integral();
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["pos"]["inc_rad"] = pos_inc_rad;
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["neg"]["inc_rad"] = neg_inc_rad;
 
 // double pos_exc_rad = h_z_D2_pos_exc_rad->Integral();
  // double neg_exc_rad = h_z_D2_neg_exc_rad->Integral();
  // jout[(std::to_string(RunGroup)).c_str()]["D2"]["pos"]["exc_rad"] = pos_exc_rad;
  // jout[(std::to_string(RunGroup)).c_str()]["D2"]["neg"]["exc_rad"] = neg_exc_rad;
  // double pos_delta = h_z_D2_pos_delta->Integral();
  // double neg_delta = h_z_D2_neg_delta->Integral();
  // jout[(std::to_string(RunGroup)).c_str()]["D2"]["pos"]["delta"] = pos_delta;
  // jout[(std::to_string(RunGroup)).c_str()]["D2"]["neg"]["delta"] = neg_delta;


  
  double pos_rho = h_z_D2_pos_rho->Integral();
  double neg_rho = h_z_D2_neg_rho->Integral();
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["pos"]["rho"] = pos_rho;
  jout[(std::to_string(RunGroup)).c_str()]["D2"]["neg"]["rho"] = neg_rho;
  std::string of_name = "results/yield20bins/run_info/simcD2_"+std::to_string(RunGroup)+"_info.json";
