...
void H2_skim_file_July21(int RunGroup = 0){
  ...
  /*
    ...
    comm july 21
  */
  std::string H2_neg_inc_norad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_neg_inc_norad.root";
  std::string H2_neg_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_neg_inc_rad.root";
  ////std::string H2_neg_exc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_neg_exc_rad.root";
  std::string H2_neg_rho_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_neg_rho.root";
  std::string H2_neg_delta_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_neg_delta.root";
  // std::string Dummy_neg_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_Dummy_neg_inc_rad.root";
  std::string H2_pos_inc_norad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_pos_inc_norad.root";
  std::string H2_pos_inc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_pos_inc_rad.root";
  std::string H2_pos_exc_rad_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_pos_exc_rad.root";
  std::string H2_pos_rho_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_pos_rho.root";
  std::string H2_pos_delta_rootfile_name = "simjuly/csv_"+std::to_string(RunGroup)+"_H2_pos_delta.root";
...
*/
  ...
  auto h_sighad_H2_neg_inc_norad = d_H2_neg_inc_norad.Histo1D({"sighad_neg_inc_norad","sighad_neg_inc_norad",bins, 0,1 },"sighad","weight_new");
  auto h_sighad_H2_pos_inc_norad = d_H2_pos_inc_norad.Histo1D({"sighad_pos_inc_norad","sighad_pos_inc_norad",bins, 0,1 },"sighad","weight_new");
  ...
  std::string rootfile_out_name = "results/yield20binsptt_july/kinematics_yield_"+std::to_string(RunGroup)+"_simc.root";
  ...
  h_sighad_H2_neg_inc_norad->Write();
  h_sighad_H2_pos_inc_norad->Write();
